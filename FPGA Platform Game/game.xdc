...
set_property PACKAGE_PIN G15 [get_ports {reset_btn}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset_btn}]
	
set_property PACKAGE_PIN K18 [get_ports {reset_btn1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset_btn1}]
